...
import static com.bendoerr.saltedmocha.nacl.CryptoStream.crypto_stream_salsa20;
...
public class CryptoStreamTest {
    @Test
    public void test_stream5() throws Exception {
        System.out.println("nacl-20110221/tests/stream5.cpp");
        ...
        byte[] out_h = decode("662b9d0e3463029156069b12f918691a98f7dfb2ca0393c96bbfc6b1fbd630a2");

        System.out.println("\tk: " + toHexString(firstkey));
        System.out.println("\tn: " + toHexString(nonce));

        byte[] c = crypto_stream_xsalsa20(4194304, nonce, firstkey);
        byte[] h = CryptoHash.crypto_hash_sha256(c);

        System.out.println("\th: " + toHexString(h));

        assertArrayEquals(out_h, h);
    }

    @Test
    public void test_steam6() throws Exception {
        System.out.println("nacl-20110221/tests/stream6.cpp");
        ...
        byte[] c = crypto_stream_salsa20(4194304, nonce, secondkey);
        byte[] h = CryptoHash.crypto_hash_sha256(c);
    ...
    @Test
    public void test_stream7() throws Exception {
        System.out.println("nacl-20110221/tests/stream7.cpp");
        ...
        byte[] c = crypto_stream_xsalsa20(32, nonce, firstkey);
    ...
    @Test
    public void test_stream8() throws Exception {
        System.out.println("nacl-20110221/tests/stream8.cpp");
        ...
        byte[] c = crypto_stream_xsalsa20_xor(m, nonce, firstkey);
        byte[] ct = new byte[c.length - 32];
        System.arraycopy(c, 32, ct, 0, ct.length);

        System.out.println("\tc: " + toHexString(ct));

        assertArrayEquals(out, ct);
    }
}
