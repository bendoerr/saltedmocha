...
public class CryptoSecretBoxTest {

    @Test
    public void test_secretbox3() throws Exception {
        System.out.println("nacl-20110221/tests/secretbox3.cpp");
        ...
        byte[] c = crypto_secretbox_xsalsa20poly1305(m, nonce, firstkey);
    ...
    @Test
    public void test_secretbox4() throws Exception {
        System.out.println("nacl-20110221/tests/secretbox4.cpp");
        ...
        byte[] m = crypto_secretbox_xsalsa20poly1305_open(c, nonce, firstkey);
    ...
    @Test
    public void test_secretbox5() throws Exception {
        System.out.println("nacl-20110221/tests/secretbox5.cpp");
        ...
        for (int mlen = 0; mlen < work; mlen++) {
            ...
            byte[] c = crypto_secretbox(m, n, k);
            byte[] m2 = crypto_secretbox_open(c, n, k);
    ...
    @Test
    public void test_secretbox6() throws Exception {
        System.out.println("nacl-20110221/tests/secretbox6.cpp");
        Random r = new SecureRandom();
        int work = 10000;
